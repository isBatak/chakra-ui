...
- [ ] 7.8 Document manual Panda and dual-engine opt-in.
- [ ] 7.9 Document how to share or extend theme definitions.
- [ ] 7.10 Exclude CLI integration tests from this plan.
