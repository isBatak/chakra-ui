...
This approach uses Panda's generated functions directly. To render Chakra
components through Emotion and Panda during an incremental migration, see the
[Styled Engine](/docs/styling/styled-engine) guide.
